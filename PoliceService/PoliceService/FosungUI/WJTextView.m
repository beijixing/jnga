...
- (void)drawRect:(CGRect)rect {
    ...
    if ((!_editing)&&self.placeHolder&&self.placeHolder.length>0&&![self hasText]) {
        [_placeHolder drawAtPoint:CGPointMake(10, 5) withAttributes:@{NSFontAttributeName:_fontOfPlaceHolder?_fontOfPlaceHolder:self.fontOfPlaceHolder,NSForegroundColorAttributeName:[UIColor lightGrayColor]}];
    }
}
