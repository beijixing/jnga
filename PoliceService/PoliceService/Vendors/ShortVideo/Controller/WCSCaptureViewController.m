...
- (void)setupRecorder
{
    _recorder = [[WKMovieRecorder alloc] initWithMaxDuration:MaxDuration];
    ...
    [_recorder setFinishBlock:^(NSDictionary *info, WKRecorderFinishedReason reason){
        switch (reason) {
            ...
            case WKRecorderFinishedReasonBeyondMaxDuration:{//正常结束
                ...
                UIStoryboard *sb = [UIStoryboard storyboardWithName:@"ShortVideo" bundle:nil];
                ...
                previewVC.shortVideoType = weakSelf.shortVideoType;
                previewVC.groupName = weakSelf.groupName;
                previewVC.groupId = weakSelf.groupId;
